...
// A private in-memory database per test. No shared file means no cross-test state
// leak and no Windows file-lock race in afterEach cleanup, which is what made the
// mergeGossipPeers row counts flake to 2 on windows-latest.
